...
, function(t, e, n) {
    ...
    ;
    var g, m = navigator.userAgent.toLowerCase(), y = r.env.touch = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch, _ = r.env.chrome = /chrome/.test(m) && /Google/.test(navigator.vendor) && parseInt(m.match(/chrome\/(\d+)\./)[1], 10), I = r.env.ios = /(ipod|iphone|ipad)/.test(m);
    ...
    t.exports = function(t, e, n, c, s, f) {
        ...
        f.set(e, t); ++E < d; ) {
            var y = t[E]
              , _ = e[E];
            if (c)
                var I = l ? c(_, y, E, e, t, f) : c(y, _, E, t, e, f);
            if (void 0 !== I) {
                if (I)
                    continue;
                g = !1;
...
, function(t, e, n) {
    ...
    function gt(t) {
        var e, n = t.store, r = t.eventId, i = t.eventTarget, o = t.eventStateKey, a = t.actionListId, u = t.groupIndex, c = void 0 === u ? 0 : u, f = t.immediate, l = t.verbose, d = n.getState(), p = d.ixData, v = d.ixSession, h = p.events[r] || {}, E = h.mediaQueries, g = void 0 === E ? p.mediaQueryKeys : E, m = (0,
        s.default)(p, "actionLists.".concat(a), {}), _ = m.actionItemGroups, I = m.useFirstGroupAsInitialState;
        if (!_ || !_.length)
            return !1;
        c >= _.length && (0,
    ...
    function mt(t) {
        ...
        u.default)(t, ["store", "computedStyle"]), c = o.element, s = o.actionItem, f = o.immediate, l = o.pluginInstance, d = o.continuous, p = o.restingValue, v = o.eventId, h = !d, g = P(), _ = r.getState(), I = _.ixElements, b = _.ixSession, T = _.ixData, O = C(I, c), w = (I[O] || {}).refState, A = y.getRefType(c), S = b.reducedMotion && E.ReducedMotionTypes[s.actionTypeId];
        if (S && d)
    ...
    t.exports = function() {
        ...
        return t.template = function(e, n, r) {
            ...
            e.replace(i, function(t, n, r, i, u) {
                return a += e.slice(o, u).replace(m, y),
                o = u + t.length,
...
, function(t, e, n) {
    var r, i, o = n(0), a = n(150), u = o.process, c = o.Deno, s = u && u.versions || c && c.version, f = s && s.v8;
...
, function(t, e, n) {
    var r, i, o, a = n(159), u = n(0), c = n(5), s = n(20), f = n(43), l = n(9), d = n(41), p = n(83), v = n(44), h = u.TypeError, E = u.WeakMap;
    if (a || d.state) {
...
, function(t, e, n) {
    var r, i = n(29), o = n(171), a = n(45), u = n(44), c = n(173), s = n(81), f = n(83), l = f("IE_PROTO"), d = function() {}, p = function(t) {
    ...
    t.exports = function(t, e, n, a, u, c) {
        ...
        for (var g = s; ++d < l; ) {
            var m = t[p = f[d]]
              , y = e[p];
            if (a)
                var _ = s ? a(y, m, p, e, t, c) : a(m, y, p, t, e, c);
...
, function(t, e, n) {
            ...
            return function(t, e, n, r, i, o) {
                ...
                case st:
                    var h = pt[r.actionTypeId]
                      ...
                      , y = n.aValue;
                    Pt(t, h, o),
                    a(t, h, y >= 1 ? "rgb(".concat(E, ",").concat(g, ",").concat(m, ")") : "rgba(".concat(E, ",").concat(g, ",").concat(m, ",").concat(y, ")"));
                    break;
                default:
                    var _ = r.config.unit
                      , I = void 0 === _ ? "" : _;
    ...
    r))
      , vt = Object.freeze((i = {},
    (0,
    c.default)(i, m.TRANSFORM_PREFIXED, I),
    (0,
    c.default)(i, M, _),
    (0,
    c.default)(i, N, N),
    ...
    function _t(t) {
        ...
        var R, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[b || O] || {}, D = Boolean(L.id || L.selector), P = o && l(yt(o.target));
    ...
    var It = /px/
      , bt = function(t, e) {
        return e.reduce(function(t, e) {
            return null == t[e.type] && (t[e.type] = xt[e.type]),
            t
        }, t || {})
    }
      , Tt = function(t, e) {
        return e.reduce(function(t, e) {
            return null == t[e.type] && (t[e.type] = Rt[e.type] || e.defaultValue || 0),
            t
        }, t || {})
    };
    var Ot = function(t, e) {
...
, function(t, e, n) {
    ...
    var r = n(4)
      ...
      , b = function(t, e) {
        ...
        null == g && (E = 1,
        g = c);
        var m, _, I, b, T = Math.max(g, 0) || 0, O = v(T - n), w = l ? d : v(n + O * E), A = 100 * w;
        if (w === n && t.current)
            return t;
      ...
      , T = function(t, e) {
        ...
        if (r && i) {
            ...
            if (s) {
                ...
                t = (0,
                o.set)(t, "verboseTimeElapsed", S * x)
            }
            if (w < 0)
                return t;
...
, function(t, e, n) {
    var r = n(8)
      ...
      , c = Math.min;
    t.exports = function(t, e, n) {
        var s, f, l, d, p, v, h = 0, E = !1, g = !1, m = !0;
        if ("function" != typeof t)
...
, function(t, e, n) {
    ...
    e.default = void 0;
    var c, s, f, l = u(n(30)), d = u(n(311)), p = u(n(60)), v = u(n(330)), h = n(4), E = n(123), g = n(65), m = n(14), y = h.EventTypeConsts, _ = y.MOUSE_CLICK, I = y.MOUSE_SECOND_CLICK, b = y.MOUSE_DOWN, T = y.MOUSE_UP, O = y.MOUSE_OVER, w = y.MOUSE_OUT, A = y.DROPDOWN_CLOSE, S = y.DROPDOWN_OPEN, x = y.SLIDER_ACTIVE, R = y.SLIDER_INACTIVE, N = y.TAB_ACTIVE, C = y.TAB_INACTIVE, L = y.NAVBAR_CLOSE, D = y.NAVBAR_OPEN, P = y.MOUSE_MOVE, M = y.PAGE_SCROLL_DOWN, j = y.SCROLL_INTO_VIEW, F = y.SCROLL_OUT_OF_VIEW, k = y.PAGE_SCROLL_UP, G = y.SCROLLING_IN_VIEW, X = y.PAGE_FINISH, V = y.ECOMMERCE_CART_CLOSE, U = y.ECOMMERCE_CART_OPEN, W = y.PAGE_START, B = y.PAGE_SCROLL, H = "COMPONENT_ACTIVE", z = "COMPONENT_INACTIVE", Y = h.IX2EngineConstants.COLON_DELIMITER, K = m.IX2VanillaUtils.getNamespacedParameterId, Q = function(t) {
        return function(e) {
            return !("object" !== (0,
            a.default)(e) || !t(e)) || e
        }
...
, function(t, e, n) {
    ...
    i.define("forms", t.exports = function(t, e) {
        var n, o, a, u, c, s = {}, f = t(document), l = window.location, d = window.XDomainRequest && !window.atob, p = ".w-form", v = /e(-)?mail/i, h = /^\S+@\S+$/, E = window.alert, g = i.env(), m = /list-manage[1-9]?.com/i, y = e.debounce(function() {
        ...
        function _(e, n) {
            ...
            m.test(s) ? i.handler = A : s || (o ? i.handler = w : y())
        }
        function I(t) {
...
, function(t, e, n) {
    ...
    r.define("navbar", t.exports = function(t, e) {
        var n, a, u, c, s = {}, f = t.tram, l = t(window), d = t(document), p = e.debounce, v = r.env(), h = '<div class="w-nav-overlay" data-wf-ignore />', E = ".w-nav", g = "w--open", m = "w--nav-dropdown-open", y = "w--nav-dropdown-toggle-open", _ = "w--nav-dropdown-list-open", I = "w--nav-link-open", b = i.triggers, T = t();
        function O() {
            r.resize.off(w)
        }
        function w() {
...
, function(t, e, n) {
    ...
    r.define("slider", t.exports = function(t, e) {
        var n, u, c, s = {}, f = t.tram, l = t(document), d = r.env(), p = ".w-slider", v = '<div class="w-slider-dot" data-wf-ignore />', h = '<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />', E = "w-slider-force-show", g = i.triggers, m = !1;
        function y() {
            (n = l.find(p)).length && (n.each(b),
            c || (_(),
            r.resize.on(I),
        ...
        function b(e, n) {
            ...
            i.nav.off(p),
            T(i),
            u ? (i.el.on("setting" + p, C(i)),
            N(i),
            i.hasTimer = !1) : (i.el.on("swipe" + p, C(i)),
        ...
        function T(t) {
            ...
            O(t.el.attr("data-hide-arrows")) ? e.hideArrows = !0 : t.config.hideArrows && (t.left.show(),
            t.right.show()),
        ...
        function w(e, n, r) {
            return function(i) {
                ...
                e.hasTimer && N(e)) : (e.ariaLiveLabel.attr("aria-live", "off"),
                e.hasTimer && R(e))
            }
        }
        function A(t, e) {
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "641a18a0d91386f8449562e6|923fbc13-9ed7-cd01-07e5-424b3da02260",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
